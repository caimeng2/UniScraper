QT.network.VERSION = 5.12.9
QT.network.name = QtNetwork
QT.network.module = Qt5Network_conda
...
QT_CONFIG += networkinterface bearermanagement openssl ftp http localserver networkdiskcache networkproxy socks5 ssl udpsocket
QT_MODULES += network
